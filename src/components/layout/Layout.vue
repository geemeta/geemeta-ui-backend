<template>
  <div class="page-wrapper xg-compact">
    <!-- BEGIN HEADER -->
              ...
              <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
                ...
                <ul class="media-list list-items">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="static/assets/layouts/layout/img/avatar7.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    <img class="media-object" src="static/assets/layouts/layout/img/avatar8.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="static/assets/layouts/layout/img/avatar9.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    <img class="media-object" src="static/assets/layouts/layout/img/avatar10.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="static/assets/layouts/layout/img/avatar11.jpg" alt="...">
                    <div class="media-body">
